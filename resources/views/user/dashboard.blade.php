    ...
    @include('layout.navbar')
      ...
      <div class="p-4 sm:p-6 lg:p-8">
       ...
       flex items-center justify-center">
              ...
              <button id="calculateEvaluationsBtn" class="hidden bg-green-500 text-white px-4 py-2 !rounded-button hover:bg-green-600 flex items-center hidden w-full sm:w-auto justify-center">
                <div class="w-4 h-4 flex items-center justify-center mr-2">
                  <i class="ri-calculator-line"></i>
                </div>
                Calculate Evaluations
              </button>
              <button id="DownloadcalculateEvaluationsSummaryBtn" class="hidden bg-green-500 text-white px-4 py-2 !rounded-button hover:bg-green-600 flex items-center hidden w-full sm:w-auto justify-center">
                <div class="w-4 h-4 flex items-center justify-center mr-2">
                  <i class="ri-calculator-line"></i>
                </div>
